 ...
 */
#ifndef LIBNULS_SYSTEM_UNICODE_HPP
#define LIBNULS_SYSTEM_UNICODE_HPP
...
// The macro BC_USE_LIBNULS_MAIN does most of the heavy lifting to ensure
...
#define BC_LOCALE_UTF8 "en_US.UTF8"
    ...
    #define BC_USE_LIBNULS_MAIN \
        ...
        int main(int argc, char* argv[]) \
        { \
            return libnuls::system::main(argc, argv); \
        }
#endif
