...
struct mnemonic_result
{
    ...
    std::string seed;
    nuls::system::wallet::dictionary language;
};
    ...
    {
        {
            ...
            nuls::system::wallet::language::en
        },
        {
...
{
    {
        ...
        },
        {
            ...
            nuls::system::wallet::language::es
        }
    }
};
...
{
    {
        ...
        },
        {
            ...
            "",
            "",
            nuls::system::wallet::language::ja
        },
        {
            "baadf00dbaadf00dbaadf00dbaadf00d",
            "博,肉,地,危,惜,多,陪,荒,因,患,伊,基",
            "",
            "",
            nuls::system::wallet::language::zh_Hans
        },
        {
            "baadf00dbaadf00dbaadf00dbaadf00d",
            "博,肉,地,危,惜,多,陪,荒,因,患,伊,基",
            "",
            "",
            nuls::system::wallet::language::zh_Hant
        }
    }
};
